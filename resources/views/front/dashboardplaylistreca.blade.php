		...
		<main id="col-main">
			...
			<div class="dashboard-container">
			    	...
			    	<ul class="dashboard-sub-menu">
                        ...
                        <li class="current"><a href="{{URL::to('/playlistsreca')}}">Recently Added</a></li>
			    		<li><a href="{{URL::to('/playlists10m')}}">Top 100 Movies</a></li>
                ...
                <div class="row">
                    @foreach ($data as $i)
			    		<div class="col-12 col-md-6 col-lg-4 col-xl-3">
                            ...
                            <a href="#!"><img src="{{ $i->poster }}" alt="{{$i->title}}"></a>
