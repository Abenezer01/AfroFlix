      ...
      <nav id="sidebar-nav"><!-- Add class="sticky-sidebar-js" for auto-height sidebar -->
        ...
        <main id="col-main">
			...
			<div class="dashboard-container">
				...
				{{-- <h4 class="heading-extra-margin-bottom">{{$tvshow->title}}</h4> --}}
				<div class="row">
					...
					<div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                            ...
                            <a href="{{URL::to('playerv/'.$i->id)}}"><img src="{{ asset('/storage/'.$i->poster) }}"></a>

                                <div class="item-listing-text-skrn">
                                <div class="item-listing-text-skrn-vertical-align"><h6><a href= "{{URL::to('playerv/' .$i->id)}}">{{$i->title}}</a></h6>
