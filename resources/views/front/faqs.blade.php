	...
	<body>
		...
		<header id="masthead-pro">
			<div class="container">
				...
				<h1><a href="/dashboard"><img src="images/logo.png" alt="Logo"></a></h1>
				...
				<a href="/signup1" class="btn btn-header-pro btn-green-pro noselect">Start a Free </a>
			...
			<nav id="mobile-navigation-pro">
				...
				<ul id="mobile-menu-pro">
					...
					<li>
						<a href="/dashboard">New Releases</a>
					...
					<li>
						<a href="/signup1">Pricing Plans</a>
					</li>
					<li>
						<a href="/faqs">FAQs</a>
					</li>
		...
		<div id="page-title-pro">
			<div class="container">
				<div class="row">
					...
					<h6>Can’t find an answer? Call us at (251) 933389902 or email <a href="mailto:help@afroflix.com">help@afroflix.com</a></h6>
				</div><!-- close .row -->
			</div><!-- close .container -->
		...
		<div id="content-pro">
  	 		...
  	 		<div class="container">
				...
				<div class="row">
					<div class="col-md">
						<h6 class="light-weight-heading">What is AfroFlix?</h6>
...
vestibulum quis luctus vel, facilisis vitae lacus. Nulla sit amet arcu a leo elementum placerat. Integer vestibulum auctor pellentesque.</p>
		...
		<footer id="footer-pro">
			<div class="container">
				<div class="row">
					<div class="col-md">
						<div class="copyright-text-pro">&copy; Copyright 2020 AfroFlix. All Rights Reserved</div>
					</div><!-- close .col -->
					<div class="col-md">
		  ...
		  <div class="modal-dialog modal-dialog-centered modal-md" role="document">
		    <div class="modal-content">
				 <div class="modal-header-pro">
					 <h2>Welcome Back</h2>
					 <h6>Sign in to your account to continue using AfroFlix</h6>
				 </div>
